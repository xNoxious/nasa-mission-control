...
const Launch = props => {
  ...
  return <Appear id="launch" animate show={props.entered}>
    ...
    <form onSubmit={props.submitLaunch} style={{display: "inline-grid", gridTemplateColumns: "auto auto", gridGap: "10px 20px"}}>
      ...
      <input required type="date" id="launch-day" name="launch-day" min={today} max="2040-12-31" defaultValue={today} />
      <label htmlFor="mission-name">Mission Name</label>
      <input required type="text" id="mission-name" name="mission-name" />
